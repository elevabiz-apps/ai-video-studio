# AI Video Studio — Create Viral Videos with AI
...
This project has 10 specialized skills installed. They provide deep domain knowledge — use them when relevant:
...
| **viral-hooks** | Crafting the first 3 seconds — 8 proven hook patterns that stop the scroll |
| **creator-formats** | Platform-specific content formats, pacing rules, and viral content formulas |
